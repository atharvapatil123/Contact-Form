...
mongoose.connect('mongodb+srv://Atharva:atharvapatil123@cluster0.ymchp.mongodb.net/ContactPage?retryWrites=true&w=majority', {useNewUrlParser: true, useUnifiedTopology: true});
...
// })
async function f(){
    var d = await Contact.find({'name':`$req.body.name`}).select({ "name": 1, "_id": 0});
    console.log(d);
}
    
app.post("/",async (req,res)=>{
    let myData = new Contact(req.body);
    myData.save().then(()=>{//returrns a promise after save
